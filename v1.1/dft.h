...
//	    _mm256_cos_pd(__m256d v1);   SVML
        ...
        if((sign > 0 && roots[1].getimag() > 0.) || (sign < 0 && roots[1].getimag() < 0.)) {
#if !defined(AVX) || AVX == 0
    ...
    for(j=0;j<NFactor;j++) {
	    ...
	    kkright = -kright;
		    ...
		    outptr[kkleft+mleft+t] = dataptr[kkright+t] - datasub2[t]; 
                ...
                if constexpr(std::is_same_v<double,Type>) {
                    ...
                    n = kkleft%2;
                    q = (kkleft+mleft)%2;
		    mw01_dft_c = _mm256_setr_pd(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag());
			    ...
			    mw01_dft_b = complex_mul_256register(mw01_dft_c,_mm256_loadu_pd((double *)&dataptr[kkright+nright+t]));
                        //mw01_dft_b = complex_mul_256register(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),(double *)&dataptr[kkright+nright+t],i);              // nright=NoverPF
                    ...
                    n = kkleft%4;
                    q = (kkleft+mleft)%4;
    		    mw01_dft_c = _mm256_setr_ps(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag());
                    for(t=0;t<tail-3;t+=4) {       // tail=1,2,3,exit at 0;  tail=4,5,6,7,exit at 4
                        ...
                        //mw01_dft_b = complex_mul_256register(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),(float *)&dataptr[kkright+nright+t],i);
                        if(m == 0)
                ...
                if constexpr(std::is_same_v<double,Type>) {
                    ...
                    n = kkleft%4;
                    q = (kkleft+mleft)%4;
    		    mw01_dft_c = _mm512_setr_pd(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag());
			    ...
			    mw01_dft_b = complex_mul_512register(mw01_dft_c,_mm512_loadu_pd((double *)&dataptr[kkright+nright+t]));
                        //mw01_dft_b = complex_mul_512register(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),(double *)&dataptr[kkright+nright+t],i);   
                        if(m == 0)
                    ...
                    n = kkleft%8;
                    q = (kkleft+mleft)%8;
       		    mw01_dft_c = _mm512_setr_ps(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag());
			    ...
			    mw01_dft_b = complex_mul_512register(mw01_dft_c,_mm512_load_ps((float *)&dataptr[kkright+nright+t]));
 		            ...
 		            mw01_dft_b = complex_mul_512register(mw01_dft_c,_mm512_loadu_ps((float *)&dataptr[kkright+nright+t]));
                        //mw01_dft_b = complex_mul_512register(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),(float *)&dataptr[kkright+nright+t],i);
                        if(m == 0)
	    ...
	    for(k=0;k<Product;k++) {
		    ...
		    i = n*k*NoverPF;
			    ...
			    datasub4[m] = datasub2[t].turnleft()*datasub1[m].getimag();
			...
			mw01_dft_e = _mm256_setr_pd(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag());
			    ...
			    if(q == 0)
			        mw01_dft_c = complex_mul_256register(mw01_dft_e,_mm256_load_pd((double *)&dataptr[kkright+nnright+t]));
    			        ...
    			        mw01_dft_c = complex_mul_256register(mw01_dft_e,_mm256_loadu_pd((double *)&dataptr[kkright+nnright+t]));
                            //mw01_dft_c = complex_mul_256register(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),(double *)&dataptr[kkright+nnright+t],q);
				...
				/*
                                for(r=0;r<2;r++) {
                                    ...
                                    datasub4[m] = datasub2[t+r].turnleft()*datasub1[m].getimag();             
				...
				*/
                                ...
                                mw01_dft_b = _mm256_set1_pd(datasub1[m].getimag());
				    ...
				    _mm256_storeu_pd((double *)&outptr[kkleft+(Factor[j]-m)*mleft+t],_mm256_fnmadd_pd(mw01_dft_d,mw01_dft_b,_mm256_fmadd_pd(mw01_dft_c,mw01_dft_a,_mm256_loadu_pd((double *)&outptr[kkleft+(Factor[j]-m)*mleft+t]))));
                        ...
                        q = (kkright+nnright)%4;
                        p = kkleft%4;
			mw01_dft_e = _mm256_setr_ps(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag());
                        for(t=0;t<tail-3;t+=4) { 
			    if(q == 0)
			        mw01_dft_c = complex_mul_256register(mw01_dft_e,_mm256_load_ps((float *)&dataptr[kkright+nnright+t]));
    			        ...
    			        mw01_dft_c = complex_mul_256register(mw01_dft_e,_mm256_loadu_ps((float *)&dataptr[kkright+nnright+t]));
                            //mw01_dft_c = complex_mul_256register(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),(float *)&dataptr[kkright+nnright+t],q);
				...
				*/
				...
				mw01_dft_a = _mm256_set1_ps(datasub1[m].getreal());
                                mw01_dft_b = _mm256_set1_ps(datasub1[m].getimag());
			...
			mw01_dft_e = _mm512_setr_pd(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag());
			    ...
			    if(q == 0)
			        mw01_dft_c = complex_mul_512register(mw01_dft_e,_mm512_load_pd((double *)&dataptr[kkright+nnright+t]));
    			        ...
    			        mw01_dft_c = complex_mul_512register(mw01_dft_e,_mm512_loadu_pd((double *)&dataptr[kkright+nnright+t]));
                            //mw01_dft_c = complex_mul_512register(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),(double *)&dataptr[kkright+nnright+t],q);
				...
				*/
		                ...
		                mw01_dft_a = _mm512_set1_pd(datasub1[m].getreal());
                                mw01_dft_b = _mm512_set1_pd(datasub1[m].getimag());
                                if((kkleft+m*mleft)%4 == 0)
				    ...
				    _mm512_storeu_pd((double *)&outptr[kkleft+(Factor[j]-m)*mleft+t],_mm512_fnmadd_pd(mw01_dft_d,mw01_dft_b,_mm512_fmadd_pd(mw01_dft_c,mw01_dft_a,_mm512_loadu_pd((double *)&outptr[kkleft+(Factor[j]-m)*mleft+t]))));
                        ...
                        q = (kkright+nnright)%8;
                        p = kkleft%8;
			mw01_dft_e = _mm512_setr_ps(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag());
                        for(t=0;t<tail-7;t+=8) { 
			    if(q == 0)
			        mw01_dft_c = complex_mul_512register(mw01_dft_e,_mm512_load_ps((float *)&dataptr[kkright+nnright+t]));
    			        ...
    			        mw01_dft_c = complex_mul_512register(mw01_dft_e,_mm512_loadu_ps((float *)&dataptr[kkright+nnright+t]));
                            //mw01_dft_c = complex_mul_512register(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),(float *)&dataptr[kkright+nnright+t],q);
				...
				*/
    			        ...
    			        mw01_dft_a = _mm512_set1_ps(datasub1[m].getreal());
                                mw01_dft_b = _mm512_set1_ps(datasub1[m].getimag());
			    ...
			    if(i == 0)
			        mw01_dft_b = complex_mul_256register(mw01_dft_c,_mm256_load_pd((double *)&dataptr[kkright+nnright+t]));
    			        ...
    			        mw01_dft_b = complex_mul_256register(mw01_dft_c,_mm256_loadu_pd((double *)&dataptr[kkright+nnright+t]));
                            //mw01_dft_b = complex_mul_256register(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),(double *)&dataptr[kkright+nnright+t],i);
                            if(m == 0)
			    ...
			    if(i == 0)
			        mw01_dft_b = complex_mul_256register(mw01_dft_c,_mm256_load_ps((float *)&dataptr[kkright+nnright+t]));
    			        ...
    			        mw01_dft_b = complex_mul_256register(mw01_dft_c,_mm256_loadu_ps((float *)&dataptr[kkright+nnright+t]));
                            //mw01_dft_b = complex_mul_256register(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),(float *)&dataptr[kkright+nnright+t],i);
                            if(m == 0)
			    ...
			    if(i == 0)
			        mw01_dft_b = complex_mul_512register(mw01_dft_c,_mm512_load_pd((double *)&dataptr[kkright+nnright+t]));
   			        ...
   			        mw01_dft_b = complex_mul_512register(mw01_dft_c,_mm512_loadu_pd((double *)&dataptr[kkright+nnright+t]));
                            //mw01_dft_b = complex_mul_512register(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),(double *)&dataptr[kkright+nnright+t],i);
                            if(m == 0)
			    ...
			    if(i == 0)
			        mw01_dft_b = complex_mul_512register(mw01_dft_c,_mm512_load_ps((float *)&dataptr[kkright+nnright+t]));
  			        ...
  			        mw01_dft_b = complex_mul_512register(mw01_dft_c,_mm512_loadu_ps((float *)&dataptr[kkright+nnright+t]));
                            //mw01_dft_b = complex_mul_512register(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),(float *)&dataptr[kkright+nnright+t],i);
                            if(m == 0)
...
void fft_func(complex<Type> *data,complex<Type> *out,int N,int Product,int sign) {    
    ...
    while(1) {
	    ...
	    kkright = kkleft<<1;
...
#elif AVX512F == 0
            if constexpr(std::is_same_v<double,Type>) {
	        mw01_fft0_c = _mm256_setr_pd(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag());
		    ...
		    //mw01_fft0_b = complex_mul_256register(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),(double *)&dataptr[kkright+nright+t],0);
	    	...
	    	mw01_fft0_c = _mm256_setr_ps(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag());
                for(t=0;t<tail-3;t+=4) {   
                    mw01_fft0_b = complex_mul_256register(mw01_fft0_c,_mm256_load_ps((float *)&dataptr[kkright+nright+t]));
                    //mw01_fft0_b = complex_mul_256register(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),(float *)&dataptr[kkright+nright+t],0);
...
#else
            if constexpr(std::is_same_v<double,Type>) {
       	    	mw01_fft0_c = _mm512_setr_pd(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag());
                for(t=0;t<tail-3;t+=4) {       
                    mw01_fft0_b = complex_mul_512register(mw01_fft0_c,_mm512_load_pd((double *)&dataptr[kkright+nright+t]));
                    //mw01_fft0_b = complex_mul_512register(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),(double *)&dataptr[kkright+nright+t],0);
       	    	...
       	    	mw01_fft0_c = _mm512_setr_ps(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag());
                for(t=0;t<tail-7;t+=8) {
		    mw01_fft0_b = complex_mul_512register(mw01_fft0_c,_mm512_load_ps((float *)&dataptr[kkright+nright+t]));
                    //mw01_fft0_b = complex_mul_512register(c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),c[0].getreal(),c[0].getimag(),(float *)&dataptr[kkright+nright+t],0);
